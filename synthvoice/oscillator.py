...
class Oscillator(synthvoice.Voice):
    ...
    def __init__(self, synthesizer:synthio.Synthesizer=None, root:float=440.0):
        ...
        self._filter_envelope = synthvoice.AREnvelope(amount=0.0)
    ...
    def fine_tune(self) -> float:
        """The amount of tuning from the root frequency of the oscillator (typically 440.0hz) in
        semitones (1/12 of an octave). Ie: 1.0 = 466.16hz (A#4) and -1.0 = 415.30hz (G#4). Defaults to 0.0.
        """
    ...
    def vibrato_depth(self) -> float:
        """The depth of the frequency LFO in octaves relative to the current note frequency and :attr:`bend`. Defaults to 0.0."""
    ...
    def tremolo_depth(self) -> float:
        """The depth of the amplitude LFO. This value is added to :attr:`amplitude`. Defaults to 0.0.
        """
    ...
    def pan_depth(self) -> float:
        """The depth of the panning LFO from 0.0 to 1.0. This value is added to :attr:`pan`. Negative values are allowed and will flip the phase of the LFO. Defaults to 0.0."""
